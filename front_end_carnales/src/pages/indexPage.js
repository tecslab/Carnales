  ...
  render() {
    return (
      ...
      <div className="text-center d-flex flex-column align-items-center">
        <a className="w-75" style={{color: '#f0ad4e'}} href="http://localhost:4000/ingresarPedidos">
          <button className="btn btn-success btn-lg w-100 my-3" type="button">Ingresoo de Pedidos</button></a>
