...
module.exports = {
  constants: {
    ...
    productos : [
      ...
      {name:'Burrito Pollo Asado', variedad: "Pollo Asado", idCategoria: 3, precio: 2.5, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{name: opciones.dividido, default: false}]},
      {name:'Burrito Carne Asada', variedad: "Carne Asada", idCategoria: 3, precio: 2.5, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[1]},
      {name:'Burrito Carne Guisada', variedad: "Carne Guisada", idCategoria: 3, precio: 2.5, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[1]},
      {name:'Burrito Al Pastor', variedad: "Al Pastor", idCategoria: 3, precio: 2.5, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false}, {idIngrediente:3, eliminable:true} ], opciones:[1]},
      {name:'Burrito Cerdo Asado Picante', variedad: "Cerdo Asado Picante", idCategoria: 3, precio: 2.5, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[1]},
      ...
      {name:'Burrito Carnitas', variedad: "Carnitas", idCategoria: 3, precio: 3, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[1]},
      {name:'Burrito Cabeza', variedad: "Cabeza", idCategoria: 3, precio: 3, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[1]},
      
      {name:'Quesadilla Pollo Asado', variedad: "Carne Asada", idCategoria: 4, precio: 3, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ]},
      ...
      {name:'Quesadilla Carne Guisada', variedad: "Carne Asada", idCategoria: 4, precio: 3, ingredientes:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ]},
