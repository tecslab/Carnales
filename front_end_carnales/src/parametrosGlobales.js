...
module.exports = {
  constants: {
    ...
    productos : [
      ...
      {name:'Burrito Chicharron', variedad: "Chicharron", labelMezcla:"Chicharrón", alias: "B. Chicharrón", idCategoria: 3, precio: 3, ingredientesVariedad:[{idIngrediente:16, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
