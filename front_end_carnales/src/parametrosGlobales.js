...
module.exports = {
  constants: {
    ...
    productos : [
      ...
      {name:'Taco Al Pastor', variedad: "Al Pastor", alias:"T. Al Pastor", idCategoria: 1, precio: 1, ingredientesVariedad:[{idIngrediente:10, eliminable:false, cant:"25", unidades:unidades.gramos}, {idIngrediente:3, eliminable:true, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[{idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:9, eliminable:false}]},
      ...
      {name:'Taco Chicharron', variedad: "Chicharrón", alias:"T. Chicharrón", idCategoria: 1, precio: 1.5, ingredientesVariedad:[{idIngrediente:16, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[{idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:9, eliminable:false}]},
      ...
      {name:'Burrito Pollo Asado', variedad: "Pollo Asado", labelMezcla:"Pollo", alias: "B. Pollo Asado", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:10, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Carne Asada', variedad: "Carne Asada", labelMezcla:"C Asada", alias: "B. Carne Asada", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:11, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Carne Guisada', variedad: "Carne Guisada", labelMezcla:"C Guisada", alias: "B. Carne Guidada", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:12, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Al Pastor', variedad: "Al Pastor", labelMezcla:"Pastor", alias: "B. Al Pastor", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:10, eliminable:false, cant:"25", unidades:unidades.gramos}, {idIngrediente:3, eliminable:true, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false}], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Cerdo Asado Picante', variedad: "Cerdo Asado Picante", labelMezcla:"Cerdo", alias: "B. Cerdo Picante", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:14, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Barbacoa de Res Picante', variedad: "Barbacoa de Res Picante", labelMezcla:"Bb Res", alias: "B. Barbacoa", idCategoria: 3, precio: 2.5, ingredientesVariedad:[{idIngrediente:15, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Chicharron', variedad: "Chicharrón", labelMezcla:"Chicharrón", alias: "B. Chicharrón", idCategoria: 3, precio: 3, ingredientesVariedad:[{idIngrediente:16, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Carnitas', variedad: "Carnitas", labelMezcla:"Carnitas", alias: "B. Carnitas", idCategoria: 3, precio: 3, ingredientesVariedad:[{idIngrediente:17, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      {name:'Burrito Cabeza', variedad: "Cabeza", labelMezcla:"Cabeza", alias: "B. Cabeza", idCategoria: 3, precio: 3, ingredientesVariedad:[{idIngrediente:18, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ], opciones:[{nombre: opciones.dividido, default: false}]},
      ...
      {name:'Quesadilla Chicharron', variedad: "Chicharrón", alias: "Q. Chicharron", idCategoria: 4, precio: 3.5, ingredientesVariedad:[{idIngrediente:16, eliminable:false, cant:"25", unidades:unidades.gramos}], ingredientesCategoria:[ {idIngrediente:1, eliminable:true}, {idIngrediente:2, eliminable:true}, {idIngrediente:4, eliminable:true}, {idIngrediente:6, eliminable:true}, {idIngrediente:7, eliminable:true}, {idIngrediente:8, eliminable:false} ]},
