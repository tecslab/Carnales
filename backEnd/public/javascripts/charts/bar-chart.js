(function ($) {
 "use strict";
	...
	var barchart1 = new Chart(ctx, {
		type: 'bar',
		data: {
			labels: ["Pollo", "Res", "Chancho", "Harina", "Frejol", "Manteca", "Aji", "Arroz", 
					'Huevos', "Ajo", "Aguacates", "Limones", "Vinagre", "Queso", "Culantro",
					"Cebolla", "Comino"],
			datasets: [{
				label: 'Ingredientes',
				data: [12, 19, 3, 5, 2, 3,7,2,5,15,11,14,16,8,2,8,1],
				backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
					'rgb(50,205,50, 0.2)',
					'rgba(255, 206, 86, 0.2)',
